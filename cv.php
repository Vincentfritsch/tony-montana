...
?>
      ...
      <div class="about-container">
        ...
        <div class="ind-main-container">
          <div class="dat_fct">
            <p class="ind-date">Feb. 1983 - Dec. 1983</p>
            <p class="arrow">&gt;</p>
            <p class="ind-fct">Mafia</p>
          </div>
          <div class="skill">
            <p class="fake"></p>
            <div class="ind-skill1">
              <ul>
        ...
        <div class="ind-main-container">
          <div class="dat_fct">
            <p class="ind-date">Jan. 1982 - feb. 1983</p>
            <p class="arrow">&gt;</p>
            <p class="ind-fct">Drugs Lord</p>
          </div>
          <div class="skill">
            <p class="fake"></p>
            <div class="ind-skill1">
        ...
        <div class="ind-main-container">
          <div class="dat_fct">
            <p class="ind-date">Aug. 1980 - dec. 1981</p>
            <p class="arrow">&gt;</p>
            <p class="ind-fct">Drug mule for Franck</p>
          </div>
          <div class="skill">
            <p class="fake"></p>
            <div class="ind-skill1">
        ...
        <div class="ind-main-container">
          <div class="dat_fct">
            <p class="ind-date">May 1980 - Aug. 1980</p>
            <p class="arrow">&gt;</p>
            <p class="ind-fct">Dishwasher in a restaurant</p>
          </div>
          <div class="skill">
            <p class="fake"></p>
            <div class="ind-skill1">
